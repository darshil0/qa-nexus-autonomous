 ...
 * Provides technical details about Gemini 2.5 models.
 */
export const geminiKnowledgeBaseSkill: Skill = {
  name: "gemini_knowledge_base",
  description: "Retrieve technical details about Gemini 2.5 models, context limits, and prompt optimization.",
  parameters: {
  ...
  execute: async ({ topic }) => {
    ...
    const data: Record<string, string> = {
      models: "Gemini 2.5 Pro is optimized for complex reasoning; Gemini 2.5 Flash is built for speed and efficiency.",
      tokens: "Gemini 2.5 supports a context window of up to 2 million tokens for Pro and 1 million for Flash.",
      json: "For best JSON results, use system instructions and provide a clear TypeScript-like schema.",
      reasoning: "Gemini 2.5 features advanced multi-pass reasoning capabilities and improved multi-modal understanding."
    };
